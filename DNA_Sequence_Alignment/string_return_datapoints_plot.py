# Run and Plot All Datapoints (Basic + Efficient) - Revised
...
def extract_file_list(dir_path="Datapoints\\"):
    """
...
def read_outputs(algorithm: str, dir_path="Datapoints\\"):
    """
...
def basic_data(dp: list, dir_path="Datapoints\\"):
    """
    ...
    for file_in in dp:
        ...
        subprocess.run([sys.executable, "string_return_basic.py", file_in, file_out])
        std_out_break()
    time, memory = read_outputs("basic")
    return time, memory


def efficient_data(dp: list, dir_path="Datapoints\\"):
    """
    ...
    for file_in in dp:
        ...
        subprocess.run([sys.executable, "string_return_efficient.py", file_in, file_out])
        std_out_break()
    time, memory = read_outputs("efficient")
    return time, memory
