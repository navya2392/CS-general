...
class BasicTest(TestCase):
    ...
    def test_basic_1_1(self):
        ...
        """
        opt_cost, aligned_s1, aligned_s2 = basic.basic_algorithm(os.path.join("SampleTestCases", "input1.txt"))
        sol, s1, s2 = read_file(os.path.join("SampleTestCases", "output1.txt"))
    ...
    def test_basic_2_1(self):
        ...
        """
        opt_cost, aligned_s1, aligned_s2 = basic.basic_algorithm(os.path.join("SampleTestCases", "input2.txt"))
        sol, s1, s2 = read_file(os.path.join("SampleTestCases", "output2.txt"))
        self.assertEqual(opt_cost, sol)
    ...
    def test_basic_3_1(self):
        ...
        """
        opt_cost, aligned_s1, aligned_s2 = basic.basic_algorithm(os.path.join("SampleTestCases", "input3.txt"))
        sol, s1, s2 = read_file(os.path.join("SampleTestCases", "output3.txt"))
        self.assertEqual(opt_cost, sol)
    ...
    def test_basic_4_1(self):
        ...
        """
        opt_cost, aligned_s1, aligned_s2 = basic.basic_algorithm(os.path.join("SampleTestCases", "input4.txt"))
        sol, s1, s2 = read_file(os.path.join("SampleTestCases", "output4.txt"))
        self.assertEqual(opt_cost, sol)
    ...
    def test_basic_5_1(self):
        ...
        """
        opt_cost, aligned_s1, aligned_s2 = basic.basic_algorithm(os.path.join("SampleTestCases", "input5.txt"))
        sol, s1, s2 = read_file(os.path.join("SampleTestCases", "output5.txt"))
        self.assertEqual(opt_cost, sol)
...
class EfficientTest(TestCase):
    ...
    def test_efficient_1_1(self):
        ...
        """
        opt_cost, aligned_s1, aligned_s2 = efficient.efficient_algorithm(os.path.join("SampleTestCases", "input1.txt"))
        sol, s1, s2 = read_file(os.path.join("SampleTestCases", "output1.txt"))
        self.assertEqual(opt_cost, sol)
    ...
    def test_efficient_2_1(self):
        ...
        """
        opt_cost, aligned_s1, aligned_s2 = efficient.efficient_algorithm(os.path.join("SampleTestCases", "input2.txt"))
        sol, s1, s2 = read_file(os.path.join("SampleTestCases", "output2.txt"))
        self.assertEqual(opt_cost, sol)
    ...
    def test_efficient_3_1(self):
        ...
        """
        opt_cost, aligned_s1, aligned_s2 = efficient.efficient_algorithm(os.path.join("SampleTestCases", "input3.txt"))
        sol, s1, s2 = read_file(os.path.join("SampleTestCases", "output3.txt"))
        self.assertEqual(opt_cost, sol)
    ...
    def test_efficient_4_1(self):
        ...
        """
        opt_cost, aligned_s1, aligned_s2 = efficient.efficient_algorithm(os.path.join("SampleTestCases", "input4.txt"))
        sol, s1, s2 = read_file(os.path.join("SampleTestCases", "output4.txt"))
        self.assertEqual(opt_cost, sol)
    ...
    def test_efficient_5_1(self):
        ...
        """
        opt_cost, aligned_s1, aligned_s2 = efficient.efficient_algorithm(os.path.join("SampleTestCases", "input5.txt"))
        sol, s1, s2 = read_file(os.path.join("SampleTestCases", "output5.txt"))
        self.assertEqual(opt_cost, sol)
